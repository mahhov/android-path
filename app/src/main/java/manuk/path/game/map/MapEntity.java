...
public abstract class MapEntity {
	...
	public static final int ENTITY_LAYER_FRIENDLY_PROJECTILE = 0, ENTITY_LAYER_HOSTILE_PROJECTILE = 1, ENTITY_LAYER_FRIENDLY_CHARACTER = 2, ENTITY_LAYER_HOSTILE_CHARACTER = 3, ENTITY_LAYER_DROPPED_ITEM = 4, ENTITY_LAYER_TRANSPARENT_FRIENDLY_CHARACTER = 5, ENTITY_LAYER_PARTICLE = 6;
